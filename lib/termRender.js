...
TermRenderer.prototype.printHelp = function(command) {
  this.stdOut(this.renderHelp(command)); //TODO: change this so that we can optionally write to a file
};

TermRenderer.prototype.version = function(version) {
  this.stdOut("Version: ".bold + version.toString().cyan.bold); // TODO: printing must be done in a separate file
};
