  ...
  describe("TermRender", function(){
    ...
    describe("#cloneArray", function(){
      it("should return an identical array of any value", function(){
        var array = [0,"string",null, {a:0}, true, [1,2,3,4], function(x){return x*x}];
    ...
    describe("#sortList", function(){
      var array1 = [
        {name:"a",mac:"666666666666",lastUsed: 15},
        {name:"b",mac:"555555555555",lastUsed: 12},
        {name:"c",mac:"444444444444",lastUsed: 13},
        {name:"d",mac:"333333333333",lastUsed: 17},
        {name:"e",mac:"222222222222",lastUsed: 20},
        {name:"f",mac:"111111111111",lastUsed: 10}
      ];
      var array2 = [
        {name:"f",mac:"111111111111",lastUsed: 10},
        {name:"e",mac:"222222222222",lastUsed: 20},
    ...
    describe("#renderList", function(){
      it("should return a string", function(done) {
        ...
        dg.getDataFromFile(function(){
          var td = require("../lib/termRender.js")(dg);
          dg.addItem({name:"test1",mac:"121212121212", lastUse: 0})
      ...
      it("should convert -Infinity to 'never'", function(done){
        ...
        dg.getDataFromFile(function(){
          var td = require("../lib/termRender.js")(dg);
          dg.addItem({name:"test1",mac:"121212121212", lastUse: -Infinity})
          var result = td.renderList();
